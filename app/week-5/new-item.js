...
export default function NewItem() {
    ...
    return (
        <form className="flex flex-col gap-5 w-1/3 border border-blue-950 rounded-2xl p-5">
            ...
            <div className="flex gap-5 justify-between">
                ...
                <div>
                    ...
                    >
                        ...
                        {Object.keys(CATEGORIES).map(category => <option value={CATEGORIES[category].val} key={CATEGORIES[category].val}>{CATEGORIES[category].text}</option>)}
                    </select>
